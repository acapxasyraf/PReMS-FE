...
function Transactions(){
    ...
    return(
        <>
            ...
            <TitleCard title="Recent Transaction" topMargin="mt-2" TopSideButtons={<TopSideButtons applySearch={applySearch} applyFilter={applyFilter} removeFilter={removeFilter}/>}>
